  ...
  return (
    <div className="headerWrap">
      ...
      <div className="bottomLeftRectangle">
        <div className="bottomLeftouterRectangleWrap">
        </div>
        <div className="bottomLeftouterRectangle">
        </div>
        <div className="bottomLeftinnerRectangleWrap">
        </div>
        <div className="bottomLeftinnerRectangle">
        </div>
      </div>
